...
const UserList = () => {
    ...
    */
    ...
    const {
        mutateAsync: roleChangeMut,
        isPending: roleChanging
    } = useRoleChange();
        ...
        await roleChangeMut(
            { users, role },
            {
                ...
                onError: (error) => {
                    ...
                    const errorMessage = error.response?.data?.message || error.message || "Failed to update user roles. Please check your connection and try again";
    ...
    const realtimeFilter = [
        {
            ...
            render: () => {
                return (
                    <Box
                        key="changeRole"
                        className={styles.roleFilterContainer}
                    >
                        <Box>
                            <RoleSelect
                                roles={USER_ROLES}
