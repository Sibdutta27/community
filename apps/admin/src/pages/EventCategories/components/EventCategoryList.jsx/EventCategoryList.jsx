...
const EventCategoryList = () => {
  ...
  const {
    ...
    // Same defect as the service categories list: the prepared filters
    // were computed and discarded, so search and pagination were inert.
  } = useEventCategory(queryFilters);
