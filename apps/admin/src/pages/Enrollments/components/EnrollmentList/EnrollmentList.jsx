...
const EnrollmentList = () => {
  ...
  const columns = [
    {
      // Rows on this list were inert — the link was commented out, so the
      // one screen that shows every application was the only one you
      // could not open an application from.
      name: "Name",
      minWidth: "180px",
      cell: (row) => (
  ...
  return (
    <>
      <Table
        ...
        columns={columns}
        loading={enrollmentFetching || statusFetching}
        selectable={false}
