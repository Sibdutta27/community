...
const steps = ["Step 1", "Step 2", "Step 3", "Step 4", "Approval"];
      ...
      { enrollmentId, isApproved },
      {
        ...
        onError: (error) => {
          ...
          const errorMessage =
            ...
            error.message ||
            "Failed to vefify enrollment. Please check your connection and try again";
    ...
    switch (activeStep) {
      ...
      case 1:
        return (
          <div className={styles.stepBody}>
            <Box sx={{ borderBottom: "1px solid #aaaaaa", paddingBottom: 2 }}>
              <Typography variant="h5">Maternal Kinship</Typography>
            </Box>
            <Box>
      ...
      case 2:
        return (
          <div className={styles.stepBody}>
            <Box sx={{ borderBottom: "1px solid #aaaaaa", paddingBottom: 2 }}>
              <Typography variant="h5">Paternal Kinship</Typography>
            </Box>
            <Box>
      ...
      case 4:
        return (
          <div className={styles.stepBody}>
            <Box sx={{ borderBottom: "1px solid #aaaaaa", paddingBottom: 2 }}>
              <Typography variant="h5">Approval section</Typography>
            </Box>
