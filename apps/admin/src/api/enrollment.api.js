...
export async function getSubmittedEnrollments(params = {}) {
  const response = await api.get("/admin/enrollment/submitted", {
    params: {
      page: params.page,
      limit: params.limit,
      search: params.search,
...
export async function getApprovedEnrollments(params = {}) {
  const response = await api.get("/admin/enrollment/approved", {
    params: {
      page: params.page,
      limit: params.limit,
      search: params.search,
...
export async function getRejectedEnrollments(params = {}) {
  const response = await api.get("/admin/enrollment/rejected", {
    params: {
      page: params.page,
      limit: params.limit,
      search: params.search,
...
export async function fetchStatusCounts() {
  const response = await api.get(`/admin/enrollment/status-counts`);
  return response.data;
}
...
export async function fetchEnrollmentStep1(enrollmentId) {
  const response = await api.get(`/admin/enrollment/step-1/${enrollmentId}`);
  return response.data;
}
...
export async function fetchEnrollmentStep2(enrollmentId) {
  const response = await api.get(`/admin/enrollment/step-2/${enrollmentId}`);
  return response.data;
}
...
export async function fetchEnrollmentStep3(enrollmentId) {
  const response = await api.get(`/admin/enrollment/step-3/${enrollmentId}`);
  return response.data;
}
...
export async function fetchEnrollmentStep4(enrollmentId) {
  const response = await api.get(`/admin/enrollment/step-4/${enrollmentId}`);
  return response.data;
}
 ...
 */
export async function fetchEnrollmentConsents(enrollmentId) {
  const response = await api.get(`/admin/enrollment/consents/${enrollmentId}`);
  return response.data;
}

/**
 * Set the verification status of a kinship (ancestry) entry
 */
export async function verifyAncestry({ enrollmentId, relation, status }) {
  const response = await api.patch(
    `/admin/enrollment/${enrollmentId}/ancestry/${relation}/verification`,
    {
      status,
    },
  );
