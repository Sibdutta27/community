...
export function HomeEnrollmentStepCard({
  ...
  return (
    <motion.article
      className="border-border bg-background shadow-card-soft relative rounded-2xl border px-4.5 pt-[2.7rem] pb-5.5 text-center sm:px-5 sm:pt-12 sm:pb-6"
    ...
    >
      ...
      <div className="min-h-13 sm:min-h-16">
        <h3
          className={cn(
            montserrat.className,
            "text-foreground text-[1.08rem] leading-tight font-semibold tracking-[-0.04em] sm:text-[1.22rem]",
          )}
        >
          {title}
        </h3>
      ...
      <p
        className={cn(
          poppins.className,
          "text-muted-foreground mt-1.5 text-[0.86rem] leading-[1.5] sm:mt-2 sm:text-[0.92rem]",
        )}
      >
        {description}
      </p>
