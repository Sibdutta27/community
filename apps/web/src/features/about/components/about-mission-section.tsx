...
export function AboutMissionSection() {
  return (
    ...
    >
      ...
      >
        <motion.article
          className="bg-foreground text-background relative overflow-hidden rounded-2xl px-5 py-8 shadow-[0_20px_44px_-32px_rgba(0,0,0,0.35)] sm:px-7 lg:px-9 lg:py-10"
          ...
          <div className="relative grid gap-6 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:items-center">
            <div className="max-w-[40rem]">
              ...
              <p
                className={cn(
                  poppins.className,
                  "text-background/80 mt-4 text-[0.9rem] leading-[1.65] sm:text-[0.96rem]",
                )}
              >
