...
export function ProfileRegionalMemberCard({
  ...
  return (
    <article className="grid grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-x-2.5 gap-y-2 rounded-[18px] bg-[#efefef] px-3.5 py-3.5 shadow-[0_14px_34px_-28px_rgba(11,32,51,0.22)] sm:px-4 sm:py-3.5 lg:min-h-[72px] lg:px-3.5 lg:py-2.5 xl:min-h-[86px] xl:px-4 xl:py-3">
      <div className="relative size-12 shrink-0 overflow-hidden rounded-full border-[3px] border-[#155f61] bg-white shadow-[0_10px_24px_-16px_rgba(11,32,51,0.36)] sm:size-[3.5rem] sm:border-[3px] lg:size-[3rem] xl:size-[3.35rem]">
        <Image
          fill
          alt={name}
