    ...
    >
      <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
        <div className="max-w-3xl">
          <h2 className="max-w-[15ch] text-[1.45rem] leading-[1.05] font-semibold tracking-[-0.04em] text-[#123b5e] sm:max-w-none sm:text-[1.65rem] lg:text-[1.85rem] xl:text-[1.9rem]">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center xl:flex-none xl:justify-end xl:gap-3">
          ...
          <Button
            className="h-[42px] w-full rounded-[12px] border-primary border-2 bg-white px-4 text-[13px] font-semibold tracking-[-0.02em] text-primary shadow-none hover:bg-[#eff6fc] hover:text-primary sm:w-[156px] sm:px-4 sm:text-[14px] lg:h-[40px] lg:w-[104px] lg:px-3 lg:text-[13px] xl:h-[44px] xl:w-[126px] xl:px-3.5 xl:text-[14px]"
            leftIcon={
              <SvgIcon
