...
export const endpoints = {
  ...
  ENROLLMENT: {
    ...
    STEP_1_DEMOGRAPHICS_SAVE_DRAFT: normalizePath(
      "/enrollment/step1/save-draft",
    ),
    ...
    STEP_2_MATERNAL_KINSHIP_SAVE_DRAFT: normalizePath(
      "/enrollment/step2/save-draft",
    ),
    ...
    STEP_3_PATERNAL_KINSHIP_SAVE_DRAFT: normalizePath(
      "/enrollment/step3/save-draft",
    ),
